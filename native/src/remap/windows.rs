...
fn vk_to_logical(vk: u32) -> LogicalKey {
    use windows::Win32::UI::Input::KeyboardAndMouse::{
        ...
        VK_F23, VK_F24, VK_F3, VK_F4 as VK_F4_C, VK_F5, VK_F6, VK_F7, VK_F8, VK_F9, VK_HOME,
    ...
    let nk = match vk as u16 {
        ...
        v if v == VK_F13.0 => NamedKey::F13,
        v if v == VK_F14.0 => NamedKey::F14,
        v if v == VK_F15.0 => NamedKey::F15,
        v if v == VK_F16.0 => NamedKey::F16,
        v if v == VK_F17.0 => NamedKey::F17,
        v if v == VK_F18.0 => NamedKey::F18,
        v if v == VK_F19.0 => NamedKey::F19,
        v if v == VK_F20.0 => NamedKey::F20,
        v if v == VK_F21.0 => NamedKey::F21,
        v if v == VK_F22.0 => NamedKey::F22,
        v if v == VK_F23.0 => NamedKey::F23,
        v if v == VK_F24.0 => NamedKey::F24,
...
fn named_to_vk(key: NamedKey) -> VIRTUAL_KEY {
    use windows::Win32::UI::Input::KeyboardAndMouse::{
        VK_APPS, VK_BACK, VK_DOWN, VK_END, VK_F1, VK_F10, VK_F11, VK_F12, VK_F13, VK_F14, VK_F15,
        VK_F16, VK_F17, VK_F18, VK_F19, VK_F2, VK_F20, VK_F21, VK_F22, VK_F23, VK_F24, VK_F3,
        VK_F5, VK_F6, VK_F7, VK_F8, VK_F9, VK_HOME, VK_LEFT, VK_NEXT, VK_OEM_1, VK_OEM_2, VK_OEM_3,
