...
fn keycode_to_logical(kc: u16) -> LogicalKey {
    ...
    let nk = match kc {
        ...
        kc if kc == KeyCode::F13 => NamedKey::F13,
        kc if kc == KeyCode::F14 => NamedKey::F14,
        kc if kc == KeyCode::F15 => NamedKey::F15,
        kc if kc == KeyCode::F16 => NamedKey::F16,
        kc if kc == KeyCode::F17 => NamedKey::F17,
        kc if kc == KeyCode::F18 => NamedKey::F18,
        // F19 never gets here — it's CapsLock, see the top of this function.
        kc if kc == KeyCode::F20 => NamedKey::F20,
...
fn named_to_keycode(key: NamedKey) -> Option<u16> {
    match key {
        ...
        NamedKey::F13 => Some(KeyCode::F13),
        NamedKey::F14 => Some(KeyCode::F14),
        NamedKey::F15 => Some(KeyCode::F15),
        NamedKey::F16 => Some(KeyCode::F16),
        NamedKey::F17 => Some(KeyCode::F17),
        NamedKey::F18 => Some(KeyCode::F18),
        NamedKey::F19 => Some(KeyCode::F19),
        NamedKey::F20 => Some(KeyCode::F20),
        // macOS virtual keycodes stop at F20.
        NamedKey::F21 | NamedKey::F22 | NamedKey::F23 | NamedKey::F24 => None,
